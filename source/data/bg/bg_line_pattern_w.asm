...
;*    Archivo de origen: bg_line_pattern_w.bmp
;*    Tamaño: 256x192 pixeles
;*    Compresion RLE habilitada
;*    Total de datos: 904 bytes
;************************************************************


BG_LINE_PATTERN_W_IMAGE:
...
db $7f, $c8, $00, $c8, $01, $c7, $7f, $c9
db $00, $c7, $01, $00

BG_LINE_PATTERN_W_CHR_1:
; Tamaño descomprimido:
db $00, $48
; Tamaño comprimido (RLE):
db $00, $14
...
;          Tamaño descomprimido: 72 bytes [$0048 bytes]
;          Tamaño RLE: 24 bytes [$0018 bytes]
...
BG_LINE_PATTERN_W_CLR_0:
; Tamaño descomprimido:
db $00, $48
; Tamaño comprimido (RLE):
db $00, $18
; Datos:
db $11, $c7, $f1, $11, $c7, $ff, $11, $c7
db $1f, $c8, $f1, $c8, $ff, $c8, $1f, $c7
db $f1, $11, $c7, $ff, $11, $c7, $1f, $11

BG_LINE_PATTERN_W_CLR_1:
; Tamaño descomprimido:
db $00, $48
; Tamaño comprimido (RLE):
db $00, $18
